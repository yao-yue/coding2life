...
Page({
  ...
  linkToConfirm() {
    ...
    wx.navigateTo({
      url: `../confirmOrder/index?id=${this.data.id}&orderType=camp`
    })
  },
  makeCall(e) {
  ...
  linkToComment(e) {
    wx.navigateTo({
      url: '../commentList/index?id=' + this.data.detailInfo.id + '&productType=campbase_product'
    })
  },
  /**
   * 用户点击右上角分享
  ...
  onShareAppMessage: function () {
    return {
      title: '驴道房车',
      path: '/pages/campDetail/index?id=' + this.data.detailInfo.id,
